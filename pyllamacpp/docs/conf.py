...
latex_documents = [
    (master_doc, 'pywhispercpp.tex', 'pywhispercpp Documentation',
...
man_pages = [
    (master_doc, 'pywhispercpp', 'pywhispercpp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pywhispercpp', 'pywhispercpp Documentation',
     author, 'pywhispercpp', 'One line description of project.',
     'Miscellaneous'),
]
